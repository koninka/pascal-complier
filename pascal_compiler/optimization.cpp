...
static bool IsEqOperands(AsmOperand* oper1, AsmOperand* oper2)
{
   ...
   if (IsReg(oper1) && IsReg(oper2)) {
      ...
      result = CastOperand<AsmVarAddr>(oper1) == oper2; /// ѕќƒ”ћј“№
   }
   return result;
}
   ...
   Add2(
      [this]() -> bool {
         return
            ...
            && IsEqOperands(Cmd(1)->arg1, Cmd(2)->arg1) //imul  eax, ebx
            && IsEqOperands(Cmd(1)->arg1, Cmd(1)->arg2); // возможно не требуетс€
      },
      [this]() {
   ...
   Add2(
      [this]() -> bool {
         return
            ...
            && !IsEqOperands(Cmd(1)->arg1, Cmd(2)->arg2); //возможно не требуетс€
      },
      [this]() {
         cmdsContainer.AddCmd(MOV, Cmd(1)->arg1, Cmd(2)->arg2);
      }
   ...
   Add3(
      [this]() -> bool {
         return
            ...
            && !IsEqOperands(Cmd(1)->arg2, Cmd(2)->arg1)
            && !IsEqOperands(Cmd(1)->arg1, Cmd(2)->arg1); // возможно не требуетс€
      },
      [this]() {
         cmdsContainer.AddCmd(Cmd(2));
   ...
   Add3(
      [this]() -> bool {
         return                                                        //mov   ebx, dword ptr - 5
            ...
            && IsMem(Cmd(3)->arg1)                                     // возможно не требуетс€
            && IsEqOperands(Cmd(2)->arg1, GetMem(Cmd(3)->arg1).arg)    // возможно не требуетс€
            && !IsMem(Cmd(1)->arg2)
